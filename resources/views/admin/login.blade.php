...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body { font-family: var(--var-font-family); display: flex; align-items: center; justify-content: center; min-height: 100vh; }
        ...
        .error { background: #ff0000; color: white; padding: 10px; border-radius: 5px; margin-bottom: 20px; text-align: center; }
        .back-link { text-align: center; margin-top: 20px; }
        .back-link a { color: #009688; text-decoration: none; }
    </style>
</head>
<body>
